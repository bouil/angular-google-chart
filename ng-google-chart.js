...
(function (document, window, angular) {
    ...
    angular.module('googlechart', [])
        ...
        .controller('GoogleChartController', ['$scope', '$attrs', '$timeout', '$window', '$rootScope', 'googleChartApiPromise', function($scope, $attrs, $timeout, $window, $rootScope, googleChartApiPromise){
          var self = this;
        ...
        .directive('googleChart',function () {
            return {
                ...
                link: function ($scope, $elm, $attrs, GoogleChartController) {
                    GoogleChartController.init($elm);
                  }
              };
        })
